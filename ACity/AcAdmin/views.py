...
def AddOfficer(request):
    ...
    return render(request,"AcAdmin/AdminRegistaration.html",{"officer_data":qs,"dept_data":qs1,"id":id})
...
def OfficerRegistaration(request):
    if request.method == "POST":
        ...
        if d1["return"]:
            ...
            Add_Officer(id=idno, name=name, department=department, contact=contact, image=image,
            ...
            return render(request, "AcAdmin/AdminRegistaration.html",
                          {"message": "Registered", "dept_data": qs, "officer_data": qs1,"name":name})
        else:
            qs = Department.objects.all()
            qs1 = Add_Officer.objects.all()
            return render(request,  "AcAdmin/AdminRegistaration.html",
...
def Complaints(request):
    ...
    return render(request,"AcAdmin/Complaints.html")